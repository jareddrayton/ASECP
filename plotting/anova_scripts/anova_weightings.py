...
glob_string = 'C:\\Users\\Jazz\\VSCODE\\Repo\\ASECP\\data\\weightings\\Primary*'
...
columns = ['vowel', 'run', 'weight_features', 'formant', 'frequency']
...
g = sns.catplot(x="vowel", y='frequency',  hue="weight_features", col="formant",
